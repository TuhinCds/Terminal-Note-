...
def __READ(file,id,filter="all"):
    filter_list = ["all", "new", "old", "last", "first"]
    __time = __show_time()
    if filter in filter_list and filter == "all" and id == 0:
        ...
        for line in __read_file:
          ...
          #    {split_line[3].split(' , ')[3]}, {split_line[3].split(' , ')[1][0:3]},
